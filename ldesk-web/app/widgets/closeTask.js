define([
    ...
    "dojo/topic",
    "dojo/text!app/widgets/templates/close_task.html",
    "dojo/domReady!"
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, baseController], { // jshint ignore:line
        ...
        submit: function (data) {
            ...
            var callback = function (obj) {
                if (obj.response.code == 200) {
                    widget.closeTaskDlg.destroyRecursive();
                    new messageWindow({
        ...
        postCreate: function () {
            var widget = this;
            this.inherited(arguments);
            widget.closeTaskDlg.show();
            on(widget.closeBtn, "click", function () {
                widget.closeTaskDlg.hide();
            });
            if ((widget.data.ownerId == undefined || widget.data.ownerId == "") || (widget.caseData.ownerName == undefined || widget.caseData.ownerName == "") || (widget.data.category != "Engineering")) {
                ...
                domStyle.set(dom.byId(widget.closeTaskForm.domNode), "display", "none");
            ...
            widget.submitBtn.on("click", lang.hitch(this, function () {
                ...
                if (!widget.closeTaskForm.isValid()) {
                    new messageWindow({
                    ...
                    info.resolution = widget.resClose.get("value");
                    info.status = "Closed";
                    info.statusId = 0;
                    widget.submit(info);
                }
